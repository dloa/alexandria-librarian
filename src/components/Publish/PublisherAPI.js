...
function registerPublisherAddress(requestedName, callback){ }
...
// Returns: Nothing other than what is returned in the callback.
function generateFlorinAddress(callback){ }
...
function addFileToIPFS(filePath, callback){ }
...
// Returns: Nothing other than what is returned in the callback.
function publishArtifact(jsonSchema, callback){ }